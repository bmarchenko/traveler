...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.zoom'
        db.add_column('traveler_country', 'zoom',
                      self.gf('django.db.models.fields.IntegerField')(default=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.zoom'
        db.delete_column('traveler_country', 'zoom')
    ...
    models = {
        ...
        'traveler.country': {
            ...
            'zoom': ('django.db.models.fields.IntegerField', [], {'default': '4', 'null': 'True', 'blank': 'True'})
        },
        'traveler.trip': {
